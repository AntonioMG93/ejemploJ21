...
import java.text.DecimalFormat;
	 ...
	 * @author 
	 */
	public class ConvierteNumeroLetra {
		 private static Integer counter=0;
		 private static String value=""; 
		 private static String nombreDeMoneda;
	     ...
	     */
	    public static String convertNumberToLetter(String doubleNumber)
	            throws NumberFormatException {
	       ...
	       // String formatedDouble = format.format(doubleNumber);
	        String formatedDouble = doubleNumber;
	        formatedDouble = formatedDouble.replace(",", ".");
	        //doubleNumber = Double.parseDouble(formatedDouble);
	        double doubleNumberCopia = Double.parseDouble(formatedDouble);

	        // Validamos que sea un numero legal
	        if (doubleNumberCopia > 999999999)
	            throw new NumberFormatException(
	                    "El numero es mayor de 999'999.999, "
	                            + "no es posible convertirlo");

	        if (doubleNumberCopia < 0)
	        ...
	        */
	        if(splitNumber.length>1){
	 	        ...
	 	        if (cents.length() == 1)
	 	        	...
	 	        	centav=splitNumber[1]+"";
	 	            //converted.append(" CON " + convertNumber(String.valueOf(centavos))
	 	            //        + "CENTAVOS");
	 	        }
	 	        
	 	        //System.out.println(centav);
	 	        if(nombreDeMoneda.equals("USD"))
	 			{				 
	 				 converted.append(" DOLARES " + centav + "/100 "+ nombreDeMoneda);
	 			}
	 			else if(nombreDeMoneda.equals("MXN"))
	 			{
	 				 converted.append(" PESOS " + centav + "/100 MXN");
	 			}else if(nombreDeMoneda.equals("EUR"))
	 			{
	 				converted.append(" EUR " + centav + "/100 EUR");
	 			}
	        }else{
	        	 String centav="0";
	 	        // Descompone los centavos
	 	        ...
	 	        int centavos = Integer.parseInt(String.valueOf(getDigitAt(
	 	                "0", 2))
	 	                + String.valueOf(getDigitAt("0", 1))
	 	                + String.valueOf(getDigitAt("0", 0)));
	 			...
	 			{
	 				converted.append(" EUR " + centav + "/100 MXN");
	 			}
	        }
